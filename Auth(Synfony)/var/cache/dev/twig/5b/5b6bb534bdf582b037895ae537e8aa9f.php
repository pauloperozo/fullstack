...
class __TwigTemplate_5ebfc7ce3d2ab7617bae871c53a195fe extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 35
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_users_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 35, $this->source); })()), "id", [], "any", false, false, false, 35)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "users/show.html.twig", "/home/paulo/prueba_full_stack/test_backend/templates/users/show.html.twig");
    }
}
